...
export const HomeBanner = () => {
  return (
    <div className="flex flex-nowrap flex-col md:flex-row items-start sm:items-center">
      <div className="w-2/4">
      ...
      <div className="w-2/4 p-8">
        ...
        <p className="text-xl font-bold text-gray-700 mt-6 home-banner-description">
