...
export const Footer = () => {
  ...
  return (
    <footer 
      id="footer" 
      className="w-full flex flex-wrap flex-row bg-slate-100 p-8 mt-8 justify-center" 
    >
      <div className="w-full flex flex-wrap flex-col md:flex-row justify-between md:px-0 max-w-screen-xl">
